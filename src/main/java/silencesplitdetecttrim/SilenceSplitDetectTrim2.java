 ...
 * @author hp
 */
public class SilenceSplitDetectTrim2 {
    ...
    //get to users id 
    public static String uid="user1";
    ...
    public static String infilePath = "C:\\xampp\\htdocs\\lireFrontend\\Voice\\php_sinhala\\Direct_upload\\2\\";
    
    //name of the file to identify the silence
   
    
    public static String infileName = "2.wav";
        ...
        for (String start : silence) {
            ...
            if(cnt%2 != 0){
                ...
                System.out.println("Silence end- "+now+" next silence start- "+next+" duration- "+duration);
                 ...
                 String letter = obj.getJSONArray("2").getString(lettercount);
